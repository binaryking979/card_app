...
export default function SignUp() {
  ...
  const handleSignUp = async () => {
    try {
      navigation.navigate("Verification", { email: email, isforgot: false });
      // if (userName === "" || email === "") {
      //   Toast.show({
      //     type: "error",
      //     text1: t("error"),
      //     text2: t("userName_email_required"),
      //   });
      //   return;
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flex: 1, marginHorizontal: 20 }}>
          <View style={{ justifyContent: "center", alignItems: "center" }}>
            ...
            />
              ...
              >
                ...
                >
                  {t("Start investing for your favourite companies with as little as $1")}
                </Text>
              </View>
              ...
              <View style={{ paddingTop: 30 }}>
                <TouchableOpacity onPress={handleSignUp} style={style.btn}>
                  <Text style={style.btntxt}>{t("sign_up")}</Text>
                </TouchableOpacity>
              </View>
          ...
          >
            <Text style={style.txt}>Already have an account?</Text>
